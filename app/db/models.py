...
class Account(Base):
    ...
    phone_hint: Mapped[str | None] = mapped_column(
        String(32),
        nullable=True,
    )
...
class Destination(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "account_id",
            "telegram_peer_id",
            name="uq_destination_account_peer",
        ),
    )
    ...
    telegram_peer_id: Mapped[int] = mapped_column(
        BigInteger,
        index=True,
    )
...
class SupportTicketMessage(Base):
    ...
    author_telegram_id: Mapped[int] = mapped_column(
        BigInteger,
        index=True,
    )
...
class AutoClickSetting(Base):
    ...
    group_peer_id: Mapped[int | None] = mapped_column(
        BigInteger,
        nullable=True,
        index=True,
    )
    ...
    group_username: Mapped[str | None] = mapped_column(
        String(255),
        nullable=True,
    )
